...
const ANS_AP10_MESH_INSTANCE = 'https://clm-sl-ans-live-ans-service-api.mesh.cf.ap10.hana.ondemand.com';
const ANS_AP11_MESH_INSTANCE = 'https://clm-sl-ans-live-ans-service-api.mesh.cf.ap11.hana.ondemand.com';
const ANS_AP12_MESH_INSTANCE = 'https://clm-sl-ans-live-ans-service-api.mesh.cf.ap12.hana.ondemand.com';
const ANS_AP20_MESH_INSTANCE = 'https://clm-sl-ans-live-ans-service-api.mesh.cf.ap20.hana.ondemand.com';
const ANS_AP21_MESH_INSTANCE = 'https://clm-sl-ans-live-ans-service-api.mesh.cf.ap21.hana.ondemand.com';
const ANS_BR10_MESH_INSTANCE = 'https://clm-sl-ans-live-ans-service-api.mesh.cf.br10.hana.ondemand.com';
const ANS_EU10_MESH_INSTANCE = 'https://clm-sl-ans-canary-ans-service-api.mesh.cf.sap.hana.ondemand.com';
const ANS_EU11_MESH_INSTANCE = 'https://clm-sl-ans-live-ans-service-api.mesh.cf.eu11.hana.ondemand.com';
const ANS_EU20_MESH_INSTANCE = 'https://clm-sl-ans-live-ans-service-api.mesh.cf.eu20.hana.ondemand.com';
const ANS_US10_MESH_INSTANCE = 'https://clm-sl-ans-live-ans-service-api.mesh.cf.us10.hana.ondemand.com';
const ANS_US20_MESH_INSTANCE = 'https://clm-sl-ans-live-ans-service-api.mesh.cf.us20.hana.ondemand.com';
const ANS_US21_MESH_INSTANCE = 'https://clm-sl-ans-live-ans-service-api.mesh.cf.us21.hana.ondemand.com';
const ANS_CH20_MESH_INSTANCE = 'https://clm-sl-ans-live-ans-service-api.mesh.cf.ch20.hana.ondemand.com';
const ANS_US30_MESH_INSTANCE = 'https://clm-sl-ans-live-ans-service-api.mesh.cf.us30.hana.ondemand.com';
const ANS_JP10_MESH_INSTANCE = 'https://clm-sl-ans-live-ans-service-api.mesh.cf.jp10.hana.ondemand.com';
const ANS_JP20_MESH_INSTANCE = 'https://clm-sl-ans-live-ans-service-api.mesh.cf.jp20.hana.ondemand.com';
const ANS_CA10_MESH_INSTANCE = 'https://clm-sl-ans-live-ans-service-api.mesh.cf.ca10.hana.ondemand.com';
const ANS_EU30_MESH_INSTANCE = 'https://clm-sl-ans-live-ans-service-api.mesh.cf.eu30.hana.ondemand.com';
const ANS_IN30_MESH_INSTANCE = 'https://clm-sl-ans-live-ans-service-api.mesh.cf.in30.hana.ondemand.com';
